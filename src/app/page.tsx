...
import { useEffect } from "react";                                                                                                         
 import {Container, Flex, Heading, SimpleGrid, GridItem, Button, Box, Divider, Stack, Modal, ModalOverlay,            
 ...
 const Home = () => {                                                                                                 
   const { timeLeft, isStart, timerType, startTimer, stopTimer, resetTimer, counterCycle, showModal, handleTakeBreak, 
 handleContinueWork } = useTimer();                                                                                   
         ...
         <Container maxWidth="container.sm">                                                                          
             <BoxWrapper>                                                                                             
                   ...
                   <Box h={{base: '15px', md:'30px'}}></Box>                                                          
                     ...
                     <Box>                                                                                            
                       <Heading variant="headingCustom" fontWeight={400} fontSize="16px">Cycle:                       
 {counterCycle}</Heading>                                                                                             
                     </Box>                                                                                           
                     <Box h={{base: '15px', md:'30px'}}></Box>                                                        
             </BoxWrapper>                                                                                            
         </Container>                                                                                                 
...

         {
          isOpen && (
            ...
            <ModalContent>                                                                                                 
              ...
              <ModalFooter>                                                                                                
                <Button colorScheme="blue" mr={3} onClick={handleTakeBreak}>                                               
                  Take Break                                                                                               
                </Button>                                                                                                  
                <Button variant="ghost" onClick={handleContinueWork}>Continue Work</Button>                                
              </ModalFooter>                                                                                               
            </ModalContent>                                                                                                
          </Modal>  
          )
